...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //kreiramo listener i callbackujemo fju cija je implementacija u {}
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.isEmpty()){
                    emailId.setError(getResources().getString(R.string.enterSmt)+" email id");
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(LoginActivity.this,"Login "+getResources().getString(R.string.unsuccess),Toast.LENGTH_SHORT).show();
                            }
                            else{
