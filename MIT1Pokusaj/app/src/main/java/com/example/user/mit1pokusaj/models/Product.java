...
public class Product implements Serializable {
    ...
    public Product(Integer id, String brand, String name, String price, String priceSign,
                   String currency, String imageLink, String productLink, String websiteLink,
                   String description, Object rating, String category, String productType,
                   List<String> tagList, String createdAt, String updatedAt, String productApiUrl,
                   String apiFeaturedImage, List<ProductColor> productColors) {
        this.id = id;
        this.brand = brand;
        this.name = name;
        this.price = price;
